...
function DashboardAside({ activeSection, onSectionChange }: DashboardAsideProps) {
  ...
  return (
    <>
      ...
      <div className="md:hidden p-4 bg-white border-b dark:bg-gray-950 dark:border-gray-700">
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="text-gray-500 dark:text-gray-300 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400"
        >
          <svg
            className="h-6 w-6"
            fill="none"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-60 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-950 dark:border-gray-700
      ...
      >
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav className="-mx-3 space-y-6"> {/* Changed space-y- to space-y-6 for consistency with Tailwind defaults */}
            <div className="space-y-3">
              <button
                onClick={() => { onSectionChange('home'); setIsOpen(false); }} // Close sidebar on click
              ...
              <button onClick={() => { onSectionChange('informes'); setIsOpen(false); }}
                className={`flex w-full items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer${
              ...
              <button onClick={() => { onSectionChange('movimientos'); setIsOpen(false); }}
                className={`flex w-full items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer${
              ...
              <button onClick={() => { onSectionChange('dashboard'); setIsOpen(false); }}
                className={`flex w-full items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer${
            ...
            <div className="space-y-3">
              <button
                onClick={() => { onSectionChange('configuracion'); setIsOpen(false); }}
                className={`flex w-full items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer ${
              ...
              <button
                onClick={() => { onSectionChange('about'); setIsOpen(false); }}
                className={`flex w-full items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer ${
